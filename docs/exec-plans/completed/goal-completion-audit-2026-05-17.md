...
- Review surface — PR #1 is open and ready for review at `https://github.com/ff-zeno/thai-accounting-app/pull/1`; GitHub reports mergeable/CLEAN with Vercel SUCCESS.
