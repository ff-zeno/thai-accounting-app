      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Record disposal date and proceeds; gain or loss is calculated from posted book value.
          </p>
        </div>
      ...
      {!orgId || !detail ? (
        <Card>
          <CardContent className="flex flex-col items-center justify-center gap-2 py-12 text-center">
            ...
            <p className="text-sm text-muted-foreground">
              Select an organization to dispose fixed assets.
            </p>
          </CardContent>
        </Card>
      ) : (
          ...
          <Card>
            ...
            <CardContent className="space-y-3 text-sm">
              ...
              <div>
                ...
                <p className="font-medium">{amount(detail.asset.originalCost)}</p>
              </div>
              <div>
                <p className="text-muted-foreground">Current book value</p>
                <p className="font-medium">{amount(detail.summary.bookValue)}</p>
              </div>
              <div>
          ...
          <Card>
            ...
            <CardContent>
              ...
              {detail.asset.disposedAt ? (
                <p className="text-sm text-muted-foreground">
                  This asset was disposed for {amount(detail.asset.disposalProceeds)} with gain/loss{" "}
