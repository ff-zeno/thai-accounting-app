...
import { profitLossToCsv } from "@/lib/gl/accounting-report-export";
...
export async function GET(request: NextRequest) {
  ...
  const csv = profitLossToCsv(summary, asOfDate);

  return new NextResponse(csv, {
    headers: {
      "Content-Type": "text/csv; charset=utf-8",
      "Content-Disposition": `attachment; filename="profit-loss-${asOfDate}.csv"`,
