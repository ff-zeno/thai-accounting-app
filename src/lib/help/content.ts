...
export const HELP_CONTENT: Record<string, HelpEntry> = {
  ...
  "/payroll": {
    title: { en: "Payroll", th: "เงินเดือน" },
    sections: [
      {
        heading: { en: "What this page is for", th: "หน้านี้มีไว้ทำอะไร" },
        body: {
          en: "Run monthly salaries here: the app computes each employee's withholding tax under the progressive personal income tax scale and the social security contributions, then produces the filings that follow.",
          th: "ใช้หน้านี้ทำเงินเดือนรายเดือน ระบบจะคำนวณภาษีหัก ณ ที่จ่ายของพนักงานแต่ละคนตามอัตราภาษีเงินได้บุคคลธรรมดาแบบขั้นบันได และเงินสมทบประกันสังคม แล้วจัดทำแบบนำส่งที่เกี่ยวข้องให้",
        },
      },
      {
        heading: { en: "PND 1", th: "ภ.ง.ด.1" },
        body: {
          en: "Tax withheld from salaries is reported on PND 1, due by the 7th of the following month (the 15th via e-filing). At year end, PND 1 Kor summarises the whole year per employee — accurate monthly runs make that summary automatic.",
          th: "ภาษีที่หักจากเงินเดือนต้องนำส่งด้วยแบบ ภ.ง.ด.1 ภายในวันที่ 7 ของเดือนถัดไป (ยื่นออนไลน์ได้ถึงวันที่ 15) และตอนสิ้นปีต้องยื่น ภ.ง.ด.1ก สรุปทั้งปีรายพนักงาน ถ้าทำเงินเดือนถูกต้องทุกเดือน แบบสรุปปีก็เสร็จเกือบอัตโนมัติ",
        },
      },
      {
        heading: { en: "Social security (SSO)", th: "ประกันสังคม" },
        body: {
          en: "Employer and employee each contribute 5% of wages, capped at a ฿15,000 wage base (at most ฿750 each per month). Contributions are due to the Social Security Office by the 15th of the following month. New hires and departures must also be registered with the SSO.",
          th: "นายจ้างและลูกจ้างสมทบฝ่ายละ 5% ของค่าจ้าง โดยคิดจากฐานค่าจ้างสูงสุด 15,000 บาท (สูงสุดฝ่ายละ 750 บาทต่อเดือน) ต้องนำส่งสำนักงานประกันสังคมภายในวันที่ 15 ของเดือนถัดไป และอย่าลืมแจ้งขึ้นทะเบียนพนักงานเข้าใหม่และแจ้งออกด้วย",
        },
      },
    ],
    terms: ["pnd1", "sso", "wht"],
  ...
  "/close": {
    title: { en: "Month-end close", th: "ปิดงวดเดือน" },
    sections: [
      {
        heading: { en: "What closing means", th: "การปิดงวดคืออะไร" },
        body: {
          en: "Closing walks a checklist: all documents processed and reviewed, the bank fully reconciled, VAT and withholding filed. When everything passes, the period is locked.",
          th: "การปิดงวดคือการไล่เช็กลิสต์ให้ครบ ได้แก่ เอกสารทุกใบผ่านการประมวลผลและตรวจทานแล้ว กระทบยอดธนาคารครบ ยื่นภาษีมูลค่าเพิ่มและภาษีหัก ณ ที่จ่ายเรียบร้อย เมื่อผ่านทุกข้อ งวดนั้นจะถูกล็อก",
        },
      },
      {
        heading: { en: "Why lock a period", th: "ทำไมต้องล็อกงวด" },
        body: {
          en: "Once a return is filed, the numbers behind it must stay exactly as filed. Locking stops accidental edits from silently pulling your books out of line with what the Revenue Department received. If something was wrong, the fix belongs in the current period or a formal amended return — not a quiet edit to history.",
          th: "เมื่อยื่นแบบไปแล้ว ตัวเลขเบื้องหลังแบบต้องคงเดิมทุกประการ การล็อกงวดป้องกันการแก้ไขโดยไม่ตั้งใจที่จะทำให้บัญชีของคุณไม่ตรงกับข้อมูลที่กรมสรรพากรได้รับไปแล้ว หากพบข้อผิดพลาด ให้แก้ในงวดปัจจุบันหรือยื่นแบบเพิ่มเติมอย่างเป็นทางการ ไม่ใช่ย้อนกลับไปแก้ประวัติเงียบ ๆ",
        },
      },
      {
        heading: { en: "What to do", th: "ควรทำอะไร" },
        body: {
          en: "Close in order: finish document review, finish reconciliation, file the month's returns, then lock. A locked month is a month you never have to think about again.",
          th: "ปิดงวดตามลำดับ คือ ตรวจเอกสารให้เสร็จ กระทบยอดให้ครบ ยื่นแบบของเดือนนั้น แล้วจึงล็อกงวด เดือนที่ล็อกแล้วคือเดือนที่คุณไม่ต้องกลับมากังวลอีกเลย",
        },
      },
    ],
    flowId: "monthly-loop",
    terms: ["period-locking", "nil-filing"],
  },

  "/fixed-assets": {
    title: { en: "Fixed assets", th: "สินทรัพย์ถาวร" },
    sections: [
      {
        heading: { en: "What this page is for", th: "หน้านี้มีไว้ทำอะไร" },
        body: {
          en: "A register of long-lived purchases — computers, machinery, vehicles, fit-out — that cannot be expensed all at once. Each asset records its cost, purchase date, and useful life, and the app books the depreciation month by month.",
          th: "ทะเบียนของที่ซื้อมาใช้งานระยะยาว เช่น คอมพิวเตอร์ เครื่องจักร รถยนต์ งานตกแต่งสำนักงาน ซึ่งลงเป็นค่าใช้จ่ายทั้งก้อนทันทีไม่ได้ สินทรัพย์แต่ละรายการบันทึกราคาทุน วันที่ซื้อ และอายุการใช้งาน แล้วระบบจะบันทึกค่าเสื่อมราคาให้เป็นรายเดือน",
        },
      },
      {
        heading: { en: "Depreciation basics", th: "พื้นฐานค่าเสื่อมราคา" },
        body: {
          en: "Depreciation spreads an asset's cost over the years it serves the business, usually in equal straight-line steps. Thai tax law caps the annual rate by asset type: computers are commonly written off over 3 years; machinery, equipment and vehicles over 5; buildings over 20.",
          th: "ค่าเสื่อมราคาคือการทยอยตัดราคาทุนของสินทรัพย์ตามจำนวนปีที่ใช้งาน โดยทั่วไปใช้วิธีเส้นตรงตัดเท่ากันทุกปี กฎหมายภาษีไทยกำหนดเพดานอัตราต่อปีตามประเภทสินทรัพย์ เช่น คอมพิวเตอร์มักตัดภายใน 3 ปี เครื่องจักร อุปกรณ์ และยานพาหนะ 5 ปี ส่วนอาคาร 20 ปี",
        },
      },
      {
        heading: { en: "Watch the special rules", th: "กฎพิเศษที่ควรรู้" },
        body: {
          en: "Input VAT on an asset purchase is claimable in the month you buy it (with a full tax invoice), even though the cost itself spreads over years. Passenger cars are the big exception: no input VAT claim, and depreciation is capped at a one-million-baht cost base.",
          th: "ภาษีซื้อจากการซื้อสินทรัพย์ขอเครดิตได้ในเดือนที่ซื้อ (ถ้ามีใบกำกับภาษีเต็มรูป) แม้ต้นทุนจะทยอยตัดหลายปีก็ตาม ข้อยกเว้นสำคัญคือรถยนต์นั่งส่วนบุคคล ซึ่งขอเครดิตภาษีซื้อไม่ได้ และคิดค่าเสื่อมได้จากฐานราคาทุนไม่เกินหนึ่งล้านบาท",
        },
      },
    ],
    terms: ["depreciation", "input-vat", "tax-invoice"],
  },
};
